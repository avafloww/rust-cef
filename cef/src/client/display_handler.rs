...
impl<T: DisplayHandler> DisplayHandlerWrapper<T> {
    ...
    unsafe extern "C" fn on_address_change(
        ...
        handler
            .internal
            .on_address_change(&browser, &frame, url.to_string())
    }
    ...
    unsafe extern "C" fn on_title_change(
        ...
        handler
            .internal
            .on_title_change(&browser, title.to_string())
    }
    ...
    unsafe extern "C" fn on_status_message(
        ...
        handler
            .internal
            .on_status_message(&browser, value.to_string())
    }
    ...
    unsafe extern "C" fn on_console_message(
        ...
        handler.internal.on_console_message(
            &browser,
            level,
            message.to_string(),
            source.to_string(),
    ...
    fn to_cef(&self) -> *mut cef_display_handler_t {
        wrap_ptr(|base| DisplayHandlerWrapper {
            _base: cef_display_handler_t {
                ...
                on_fullscreen_mode_change: Some(
                    DisplayHandlerWrapper::<T>::on_fullscreen_mode_change,
                ),
